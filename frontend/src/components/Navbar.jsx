        ...
        >
          <div className="px-4 pb-4 bg-white border-t border-gray-200">
            <div className="flex flex-col space-y-1">
              <Link to="/leaderboard" className="py-3 px-2 text-base font-medium hover:bg-gray-100 rounded transition-colors" onClick={closeMobileMenu}>
                Leaderboard
              </Link>
              <Link to="/dsa-visualizer" className="py-3 px-2 text-base font-medium hover:bg-gray-100 rounded transition-colors" onClick={closeMobileMenu}>
                Algorithms
              </Link>
              <Link to="/QuestionTracker" className="py-3 px-2 text-base font-medium hover:bg-gray-100 rounded transition-colors" onClick={closeMobileMenu}>
                Question Tracker
              </Link>

              {/* Profile Tracker (mobile) */}
              <div className="py-2">
                <div className="text-sm font-semibold text-gray-600 px-2 py-1">Profile Tracker</div>
                <Link to="/CodeForces" className="py-2 px-4 text-base hover:bg-gray-100 rounded transition-colors block" onClick={closeMobileMenu}>
                  Codeforces
                </Link>
                <Link to="/portfolio" className="py-2 px-4 text-base hover:bg-gray-100 rounded transition-colors block" onClick={closeMobileMenu}>
                  Coding <span className="text-orange-500">Portfolio</span>
                </Link>
                <Link to="/events" className="py-2 px-4 text-base hover:bg-gray-100 rounded transition-colors block" onClick={closeMobileMenu}>
                  Event Tracker
                </Link>
              </div>
              ...
              <div className="py-2">
                ...
                <Link to="/Freindcomparison" className="py-2 px-4 text-base hover:bg-gray-100 rounded transition-colors block" onClick={closeMobileMenu}>
                  Comparison
                </Link>
                <Link to="/workingpage" className="py-2 px-4 text-base hover:bg-gray-100 rounded transition-colors block" onClick={closeMobileMenu}>
                  Coding Battle
                </Link>
                <Link to="/workingpage" className="py-2 px-4 text-base hover:bg-gray-100 rounded transition-colors block" onClick={closeMobileMenu}>
                  Create Room
